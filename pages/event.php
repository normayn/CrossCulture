...
<!--event map, culture buttons and sidebar-->
<div id="container" style="margin-left: 7%; margin-right: 7%; margin-top: 30px;" style="z-index:100">
    ...
    <div class="row">
        <div id="buttonculture" class="col-lg-1 col-md-2 col-sm-3 col-xs-3">
            ...
            <br>
            <button class="denem1 hvr-grow" onclick="load('Chinese OR China')" data-toggle="tooltip"
                    title="Chinese"></button>
            <br>
            <button class="denem2 hvr-grow" onclick="load('Greek OR Greece')" data-toggle="tooltip"
                    title="Greek"></button>
            <br>
            <button class="denem3 hvr-grow" onclick="load('Indian OR India')" data-toggle="tooltip"
                    title="Indian"></button>
            <br>
            <button class="denem4 hvr-grow" onclick="load('Italian OR Italy')" data-toggle="tooltip"
                    title="Italian"></button>
            <br>
            <button class="denem5 hvr-grow" onclick="load('Turkish OR Turkey')" data-toggle="tooltip"
                    title="Turkish"></button>
        </div>
...
<script>
    //to replace missing or broken images with an alternative
