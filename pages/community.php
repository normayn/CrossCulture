...
<!--community map, buttons and sidebar-->
<div id="container" style="margin-left: 7%; margin-right: 7%; margin-top: 30px;" style="z-index:100">
    <div class="row">
        <div id="buttonculture" class="col-lg-1 col-md-2 col-sm-3 col-xs-3">
            ...
            <br>
            <button class="denem1 hvr-grow" onclick="load('China')" data-toggle="tooltip" title="Chinese"></button>
            <br>
...
<script src="../js/commap.js" type="text/javascript"></script>
